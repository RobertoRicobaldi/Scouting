...
BASE_PATH = r"C:\\Users\\rricobaldi\\Desktop\\Atlético de Madrid\\Atlético de Madrid\\Departamento Captación\\Seguimiento Jugadoras"
...
# -------------------- FILTROS Y DATOS --------------------
    ...
    st.write("Visualiza el dataset completo y explora información básica")

    st.subheader("Filtrado por equipo, posición, edad y calificación")
